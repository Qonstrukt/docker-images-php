...
docker tag ${OWNER}/php:${PHP_VERSION}-${BRANCH}-${BRANCH_VARIANT}-node14-${CURRENT_ARCH} ${OWNER}/php:${PHP_PATCH_VERSION}-${BRANCH}-${BRANCH_VARIANT}-node14-${CURRENT_ARCH}
docker tag ${OWNER}/php:${PHP_VERSION}-${BRANCH}-${BRANCH_VARIANT}-node16-${CURRENT_ARCH} ${OWNER}/php:${PHP_PATCH_VERSION}-${BRANCH}-${BRANCH_VARIANT}-node16-${CURRENT_ARCH}
