...
docker manifest create \
    ${OWNER}/php:${PHP_VERSION}-v4-${BRANCH_VARIANT}-node12 \
    --amend ${OWNER}/php:${PHP_VERSION}-v4-${BRANCH_VARIANT}-node12-amd64 \
    --amend ${OWNER}/php:${PHP_VERSION}-v4-${BRANCH_VARIANT}-node12-arm64
docker manifest push ${OWNER}/php:${PHP_VERSION}-v4-${BRANCH_VARIANT}-node12

docker manifest create \
    ${OWNER}/php:${PHP_PATCH_VERSION}-v4-${BRANCH_VARIANT}-node12 \
    --amend ${OWNER}/php:${PHP_PATCH_VERSION}-v4-${BRANCH_VARIANT}-node12-amd64 \
    --amend ${OWNER}/php:${PHP_PATCH_VERSION}-v4-${BRANCH_VARIANT}-node12-arm64
docker manifest push ${OWNER}/php:${PHP_PATCH_VERSION}-v4-${BRANCH_VARIANT}-node12
